...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Fetch the current user immediately
      const currentUser = await account.get();
      setUser(currentUser); // set in AuthContext
      ...
      >
        <Card className="shadow-xl">
          <CardHeader className="space-y-1">
            <CardTitle className="text-3xl font-bold text-center font-display">Welcome Back</CardTitle>
